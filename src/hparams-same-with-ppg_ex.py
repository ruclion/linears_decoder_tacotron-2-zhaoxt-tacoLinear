...
hparams = tf.contrib.training.HParams(
	...
	#Mel spectrogram
	n_fft = 400,#1024, #Extra window size is filled with 0 paddings to match this parameter
	hop_size = 80,#200, #For 22050Hz, 275 ~= 12.5 ms (0.0125 * sample_rate)
	win_size = 400,#800, #For 22050Hz, 1100 ~= 50 ms (If None, win_size = n_fft) (0.05 * sample_rate)
	...
	tacotron_final_learning_rate = 1e-5, #minimal learning rate1
	...
	tacotron_reg_weight = 6e-5, #regularization weight (for L2 regularization)
